      ...
      <div className="container">
        ...
        <div className="footer-bottom">
          ...
          <p className="footer-contact">
            Need immediate assistance? Email: <a href={`mailto:${process.env.REACT_APP_GMAIL_LINK || 'omslabs1st@gmail.com'}`}>
              {process.env.REACT_APP_GMAIL_LINK || 'omslabs1st@gmail.com'}
            </a>
          </p>
        </div>
      </div>
